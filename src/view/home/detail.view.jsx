  ...
  return (
    <div className="max-w-6xl mx-auto p-10 space-y-6 bg-white dark:bg-neutral-900 rounded-2xl">
      {loadingSingleRecipes ? (
        ...
        <div className="grid grid-cols-1 items-start gap-5">
          <div className="grid grid-cols-1 md:flex items-center md:items-start gap-5">
            <div className="flex items-start justify-center">
              <img
                ...
                alt={recipe?.slug}
                className="w-50 h-50 md:w-52 md:h-52 lg:w-125 lg:h-96 rounded-2xl object-contain"
              />
            </div>
            {/* Title */}
            <div className="space-y-2 md:space-y-6">
